...
class User extends DataClass implements Insertable<User> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, username, passwordHash, salt, createdAt, updatedAt);
  @override
...
class Session extends DataClass implements Insertable<Session> {
  ...
  @override
  int get hashCode => Object.hash(id, userId, token, expiresAt, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Session &&
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [users, todos, sessions];
  @override
...
class $$UsersTableTableManager
    extends
        RootTableManager<
          ...
          User,
          PrefetchHooks Function({bool todosRefs, bool sessionsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({todosRefs = false, sessionsRefs = false}) {
